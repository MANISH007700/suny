...
RAG Pattern: Student question → Search vector DB for relevant course/degree documents → Pass documents + question to Gemini → Return answer with citations 
...
Create advising session summaries 
...
Frontend: React + Tremor (dashboard UI library) or Recharts for visualizations 
